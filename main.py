...
# TODO: ensure the list[Col].contains(Col) never happens
...
from columns import Expr, Col, Func, Lit
...
# class Subnode(Protocol):
#     def __init__(self, expressions: ColumnSpec) -> None:
#         """
#         expressions: dict of new names to their definitions
#         in terms of string arithmetic expressions.
#         a.k.a. Quick and dirty column-node tree without the tree
#         """
#         ...

#     def execute(self, named_chunks: dict[str, Chunk]) -> Chunk: ...
